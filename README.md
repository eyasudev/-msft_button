...
Breif description: "An IoT powered switch that mutes and unmute a user on a Microsoft Teams call"
...
Detail: "This project invovles the development of a Python console application and an IoT embedded device. The Python app uses the Mircosoft Graph API to control the mute and unmute action in a Teams call

This repo includes the python desktop application and the esp32 firmware source code "
